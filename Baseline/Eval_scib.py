...
parser.add_argument('--ari',action = 'store_true', default=False)
...
for file in files:
    ...
    res = scib.metrics.metrics(adata=adata_unintegrated, adata_int=adata,
                            ...
                            ari_ = args.ari,cell_cycle_ = args.CC, organism='human' ) 
...
with open('./evaluation/metric_ari_test.pkl','wb') as f:
